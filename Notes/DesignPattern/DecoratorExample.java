...
public class DecoratorExample {
    public static void main(String[] args) {
        ...
        System.out.println(latte.getDescription() + " $" + String.format("%.2f", latte.cost()));
    }
}

/*
 * 1. 为什么 CondimentDecorator 需要 abstract String getDescription();
 * 
 ...
 * 
 * 
 * 2. 为什么latte 打印价格为3.4000000000000004
 * Java 采用 IEEE 754 浮点数标准来存储 double，由于浮点数不能精确存储某些小数，导致计算时出现 微小误差。
 */