...
// Key takeaway:
// 1. Multiple threads increment the counter simultaneously using incrementAndGet(), which ensures atomic updates without using locks.
// 2. The final counter value will be consistent and correct, even though multiple threads are updating it concurrently.
